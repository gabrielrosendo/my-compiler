...
parser: lex.yy.c parser.tab.c AST.c parser.tab.h symbolBST.c semantic.c codeGenerator.c
	@gcc -o parser parser.tab.c AST.c lex.yy.c symbolBST.c semantic.c codeGenerator.c symbolBST_Test.c
	@./parser input.txt
